...
import { Home as HomeIcon, Wallet as WalletIcon, BarChart2, Settings, LogOut, Smartphone, Bitcoin, CircleDollarSign, Coins, DollarSign, Copy} from "lucide-react";
    ...
    <div className="flex bg-[#1a1a1a] text-white">
      ...
      <aside className="space-y-6 fixed top-0 left-0 h-screen w-64 bg-[#111111] flex flex-col p-4 shadow overflow-y-auto">        
        ...
        <div className="flex items-center mb-8">
          ...
          <div className="flex flex-col">
            <div className="flex justify-between w-44">
              ...
              <p className="text-sm text-green-400 bg-green-950">Verified</p>
            </div>
        ...
        <nav className="space-y-4">        
          <Link className="flex items-center space-x-2 hover:text-yellow-500" to="/home">
            <HomeIcon size={18} /> <span>Dashboard</span>
          </Link>
          <Link className="flex items-center space-x-2 hover:text-yellow-500" to="/login">
        ...
        <div className="flex-1 flex flex-col">
          ...
          {/* Dummy Navbar */}
          <nav className="ml-64 flex items-center justify-between px-6 py-4 text-sm text-gray-300">
